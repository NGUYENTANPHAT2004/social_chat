...
export class EmailService {
  ...
  constructor(private configService: ConfigService) {
    const apiKey = this.configService.get<string>('notifications.email.resend.apiKey');
    this.fromEmail = this.configService.get<string>('notifications.email.resend.fromEmail', 'noreply@yourdomain.com');
    this.fromName = this.configService.get<string>('notifications.email.resend.fromName', 'Entertainment Platform');
